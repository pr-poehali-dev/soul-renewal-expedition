...
const places = [
  { name: "Долина Приведений", desc: "Мистическая долина с каменными великанами на склонах Демерджи. Место, где скалы хранят память тысячелетий и пробуждают внутренние трансформации.", icon: "🗿", img: HERO_IMG },
  { name: "Мыс Меганом", desc: "Сакральный мыс с пересечением мощных энергетических потоков. Место медитаций и ретритов.", icon: "🌊", img: ENERGY_IMG },
  { name: "Демерджи", desc: "Скала-великан с каменными истуканами. Место трансформации и встречи с силой стихий.", icon: "⛰️", img: PANORAMA_IMG },
  { name: "Чатыр-Даг", desc: "Высокогорное плато — точка между небом и землёй. Место ясности и обновления.", icon: "🏔️", img: HERO_IMG },
  { name: "Мыс Фиолент", desc: "Скалистый берег с кристальной водой. Место очищения морской стихией.", icon: "💎", img: PANORAMA_IMG },
  { name: "Мангуп-Кале", desc: "Пещерный город на вершине горы. Место силы древних цивилизаций Крыма.", icon: "🗺️", img: ENERGY_IMG },
];
...
const reviews = [
  { name: "Анна М.", city: "Москва", text: "Это был самый сильный опыт в моей жизни. Карадаг буквально перевернул моё восприятие. Вернулась другим человеком.", stars: 5 },
  ...
  { name: "Елена Р.", city: "Екатеринбург", text: "Приехала с выгоранием, уехала с огнём в сердце. Практики у скал работают на каком-то очень глубоком уровне.", stars: 5 },
  { name: "Дмитрий В.", city: "Краснодар", text: "Демерджи ночью — это незабываемо. Звёзды, тишина, чувство единства с горой. Буду возвращаться снова.", stars: 5 },
];
