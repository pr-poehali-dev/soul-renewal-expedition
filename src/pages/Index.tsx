...
const places = [
  ...
  { name: "Храм Солнца", desc: "Природный амфитеатр из каменных глыб на мысе Фиолент. Древнее место силы, где солнечная энергия заряжает и пробуждает внутренний свет.", icon: "☀️", img: HERO_IMG },
